Locales['fr'] = {
  ...
  ['service_out_announce'] = 'L\'agent ~y~%s~s~ à pris sa fin de service.',
  -- Action Menu
  ...
  ['fine'] = 'Amende',
  ['unpaid_bills'] = 'Gérer les amendes non payées',
  ...
  ['no_players_nearby'] = 'Aucun ~r~~h~joueur à proximité',
  -- Vehicle interaction
  ...
  ['you_confiscated'] = 'Vous avec confisquer ~y~%sx~s~ ~b~%s~s~ à ~b~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~b~%s~s~ confisqué par ~y~%s~s~',
  ['you_confiscated_account'] = 'Vous avez confisquer ~g~€%s~s~ (%s) à ~b~%s~s~',
  ['got_confiscated_account'] = '~g~€%s~s~ (%s) confisqué par ~y~%s~s~',
  ...
  ['have_deposited'] = 'Vous avez ajouté ~y~%sx~s~ ~b~%s~s~',
  ['quantity'] = 'Quantité',
